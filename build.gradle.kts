/*
 * Based on: TerraFirmaCraft (curseforge.com/minecraft/mc-mods/terrafirmacraft)
 * build file (github.com/TerraFirmaCraft/TerraFirmaCraft), EUPL v1.2 license
 */
...
val modId: String = "lambdynlights" //System.getenv("VERSION") ?: "0.0.0-indev"
val modVersion: String = "0.9.1"
...
base {
    archivesName.set("$modId-forge-[mc$minecraftVersion]")
    group = "com.llamastein.tdt"
    version = modVersion
}
...
//    }
    ...
    register("generateSources", Copy::class) {
        ...
        filesMatching("**/LambDynLightsMod.java") {
            expand(mapOf("version" to project.version))
        }
    }
...
//sourceSets { main { output.setResourcesDir(output.classesDirs) } }
